...
buildDotnetModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "c52be4379e38f250e063c6ea041dbdf17b52143d";
    sha256 = "sha256-XugfWDskmhOMfuEnPEFamuzBJpXPPpE854y302xZLLU=";
  };

  patches = [
    ./opentabletdriver-xppen13.patch
  ];
